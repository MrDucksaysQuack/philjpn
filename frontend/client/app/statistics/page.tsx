          ...
          {isLoading ? (
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl shadow-lg p-8 border border-green-200 hover:shadow-xl transition-all">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="text-sm font-semibold text-green-700">최고 점수</div>
                  </div>
            ...
            <div className="text-center py-20">
              <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl mb-6 shadow-lg">
