        ...
        <div className="space-y-4">
          {topRecommendations.map((rec: any) => (
            <Link
              ...
              className="group block bg-gradient-to-r from-theme-secondary/10 to-theme-accent/10 rounded-xl p-6 border border-theme-secondary/20 hover:border-theme-secondary/40 hover:shadow-lg transition-all"
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-sm font-semibold text-theme-secondary bg-theme-secondary/20 px-3 py-1 rounded-full">
                      적합도 {Math.round(rec.matchScore * 100)}%
                    </span>
                  </div>
                  <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-theme-secondary transition-colors">
                ...
                <div className="ml-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-theme-secondary to-theme-accent rounded-lg flex items-center justify-center transform group-hover:scale-110 transition-transform">
