...
- **위치**: ❌ Admin 페이지 없음
- **API 상태**: ✅ Backend API 존재 (`categoryAPI`)
- **필요한 기능**:
  - 카테고리 생성, 수정, 삭제
  - 카테고리 순서 관리 (order)
  - 카테고리 활성화/비활성화
...
#### 3. **Badges (배지 관리)**
- **위치**: ❌ Admin 페이지 없음
- **API 상태**: ⚠️ Backend Service 존재하나 Frontend API 확인 필요
- **필요한 기능**:
  - 배지 생성, 수정, 삭제
  - 배지 유형 및 희귀도 설정
  - 배지 조건 설정 (condition JSONB)
  - 배지 활성화/비활성화
- **Frontend 활용**: ⚠️ 확인 필요 (사용자 프로필, 목표 달성 페이지에서 사용 예상)
- **우선순위**: 🟡 중간 (게이미피케이션 기능)
...
1. **Badges**
   - 사용자 프로필에 배지 표시 필요
   - 목표 달성 페이지에 배지 획득 표시 필요
   - 배지 목록 페이지 필요

2. **UserGoals**
   - 사용자 대시보드에 목표 진행 상황 표시 필요
   - 목표 설정 페이지 필요
...
- [x] Monitoring
- [ ] **Categories 관리** ⚠️ 미구현
- [ ] **Subcategories 관리** ⚠️ 미구현
- [ ] **Badges 관리** ⚠️ 미구현
- [ ] QuestionBanks 관리 (선택적)
...
- [x] LicenseKeys 접근 제어
- [ ] **Badges 표시** ⚠️ 미구현
- [ ] **UserGoals 표시** ⚠️ 확인 필요
- [ ] WordBooks 활용 확인 필요
- [ ] LearningPatterns 활용 확인 필요
